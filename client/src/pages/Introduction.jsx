  ...
  return (
    <div className="intro-container">
      ...
      <p className="intro-description">
        <strong>CodexRadar</strong> is a full-stack competitive programming performance tracking platform. Designed for both
        <strong> college admins</strong> and <strong>Codeforces users</strong>, it automates data sync, visualizes performance,
